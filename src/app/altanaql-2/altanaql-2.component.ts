...
@Component({
  selector: 'app-altanaql-2',
  templateUrl: './altanaql-2.component.html',
  styleUrl: './altanaql-2.component.css'
})
export class Altanaql2Component implements OnInit {
  ...
  const correctAnswers5 = ['يتنقل مشيا', 'يتنقل سباحة', 'يتنقل قفزا', 'يتنقل زحفا', 'يتنقل عدوا ', 'يتنقل طيرانا', 'يتنقل مشيا', 'يتنقل طيرانا'];
