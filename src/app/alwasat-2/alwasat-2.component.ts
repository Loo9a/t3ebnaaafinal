...
@Component({
  selector: 'app-alwasat-2',
  templateUrl: './alwasat-2.component.html',
  styleUrl: './alwasat-2.component.css'
})
export class Alwasat2Component implements OnInit {
  ...
  const correctAnswers3 = [true, false, false, true, true, false, true, true, true, true, false, true, false, false, true, false, true, true];
...
const correctAnswers4 = ['تصرف لائق', 'تصرف غير لائق', 'تصرف لائق', 'تصرف لائق', 'تصرف غير لائق', 'تصرف لائق', 'تصرف غير لائق', 'تصرف لائق'];
...
const correctAnswers5 = ['نبتة مغروسة', 'نبتة مزروعة', 'نبتة مزروعة', 'نبتة مزروعة', 'نبتة تلقائية', 'نبتة مغروسة', 'نبتة تلقائية', 'نبتة مغروسة'];
