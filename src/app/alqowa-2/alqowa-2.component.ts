...
@Component({
  selector: 'app-alqowa-2',
  templateUrl: './alqowa-2.component.html',
  styleUrl: './alqowa-2.component.css'
})
export class Alqowa2Component  implements OnInit {
  ...
  const correctAnswers5 = ['القوة العضلية', 'القوة الكهربائية', 'القوة العضلية ', 'القوة المغناطيسية'];
  ...
  const correctAnswers4 = ['قوة الجذب', 'قوة الدفع', 'قوة الجذب', 'قوة الدفع'];
